...
function LOGO() {
 ...
 ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───
 ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───
    │    ${YELLOW}Copyright${FONT} (C)$GRAY RexxCloudID$NC   │
    └───────────────────────────────────────────────┘
...
clear;clear;clear
  ...
  # // Banner
echo -e "${RED}◇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◇${NC}"
echo -e "  Welcome To VPN RexxCloudID Script Manager ${BLUE}(${NC}${BLUE} New Edition ${NC}${BLUE})${NC}"
echo -e "     This Will Quick Setup VPN Server On Your Server"
echo -e "         Authorr : ${BLUE} RexxCloudID ${NC}${BLUE}(${NC} ${BLUE} RexxCloudID ${NC}${BLUE})${NC}"
echo -e "       © Recode By RexxCloudID ${BLUE}(${NC} 2023 ${BLUE})${NC}"
echo -e "${RED}◇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◇${NC}"
echo ""
sleep 3
###### IZIN SC 
...
data_ip="https://raw.githubusercontent.com/Kiraavpn/kira/main/license/izin"
...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/RexxCloudID"
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/6288232154376"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Kiraavpn/kira/main/license/izin | grep $MYIP | awk '{print $2}')
#username=$(curl https://abc.xcodehoster.com/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Kiraavpn/kira/main/license/izin | grep $MYIP | awk '{print $3}')
$expx=$(curl https://raw.githubusercontent.com/Kiraavpn/kira/main/license/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Kiraavpn/kira/main/license/izin | grep $MYIP | awk '{print $4}')
...
clear
# REPO    
    REPO="https://rexxcloudid--skyzoodev.repl.co/"
...
echo -e " ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───"
echo -e " ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───"
echo -e "    │    ${YELLOW}Copyright${FONT} (C)$GRAY RexxCloudID$NC         │"
echo -e "    └───────────────────────────────────────────────┘"
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    curl https://raw.githubusercontent.com/Vatay70/sc/main/ssh/nginx.conf > /etc/nginx/nginx.conf
...
function menu(){
    ...
    cd /usr/local/sbin
    wget https://raw.githubusercontent.com/Kiraavpn/kira/main/menu/menu.zip
    unzip menu.zip
    chmod +x *
    rm -rf menu.zip
#botmintod
...
domain=$(cat /etc/xray/domain)
    ...
    USRSC=$(curl https://raw.githubusercontent.com/Kiraavpn/kira/main/license/izin | grep $ipsaya | awk '{print $2}')
    EXPSC=$(curl https://raw.githubusercontent.com/Kiraavpn/kira/main/license/izin | grep $ipsaya | awk '{print $3}')
    TIMES=`date -d "0 days" +"%d-%m-%Y" `
    TIMEZONE=$(printf '%(%H:%M:%S)T')
    TEXT="
<code>────────────────────</code>
<b>   AUTOSCRIPT REXX TUNNEL  </b>
<code>────────────────────</code>
...
<i>RexxCloudl</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"t.me/RexxCloudID"},{"text":"GRUP🐬","url":"https://t.me/"}]]}'
...
echo "    ============================" | tee -a log-install.txt
echo "  ⚠︎𝘽𝙮 𝙋𝙧𝙤𝙟𝙚𝙘𝙩 𝙈𝙖𝙣𝙖𝙜𝙚𝙧 𝘾𝙤𝙢𝙢𝙪𝙣𝙞𝙩𝙮⚠︎" | tee -a log-install.txt
echo "    ============================" | tee -a log-install.txt
echo ""
...
echo ""
read -n 1 -s -r -p "Press ➥ Enter To Reboot Server"
echo ""
sleep 10
reboot
